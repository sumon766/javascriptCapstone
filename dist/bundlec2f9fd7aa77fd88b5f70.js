...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _modules_commentPopup__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/commentPopup */ "./src/modules/commentPopup.js");
...
const showMovies = async () => {
  ...
  received.forEach(movie => {
    if (movie.id < 7) {
      ...
      (0,_modules_commentPopup__WEBPACK_IMPORTED_MODULE_0__.commentPop)(movie, program)
...
const getData = async (url) => {
    try {
        const comments = await axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(url)
        console.log(comments, "0000")
        return comments
    }
    catch (error) {
...
const commentPop = (movie, program) => {
    ...
    submit.addEventListener("click", async (e) => {
        ...
        if (name.value && commentText.value) {
            let result = await (0,_commentAPI__WEBPACK_IMPORTED_MODULE_0__.addComment)(movie.id, name.value, commentText.value)
            // if (result) {
...
/******/ })()
;
//# sourceMappingURL=bundlec2f9fd7aa77fd88b5f70.js.map